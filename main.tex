...
The details and constraints of the puzzle will be described further in Section \ref{section: lit review}.
...
The construction of the wrapping is based on that proposed by Michael Paterson, featured in Demaine et al. on page 16 (Figure \ref{fig: knotted})\cite{Demaine_2013}.
...
\pagebreak
\section{Literature Review} \label{section: lit review}
