...
But what if we were to hang the picture by two nails? Hanging the picture in the simplest way, as illustrated in Figure \ref{fig: two_normal}, removing either nail would not cause the picture frame to fall.
